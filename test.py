...
def test(args, test_loader, model):
    ...
    for i, (input, label, size, name) in enumerate(test_loader):
        ...
        output1,output2,output3,output4= model(input_var) #,output5,output6,output7,output8
        torch.cuda.synchronize()
        time_taken = time.time() - start_time
        print('[%d/%d]  time: %.2f' % (i + 1, total_batches, time_taken))
        output1 = output1.cpu().data[0].numpy()
        output2 = output2.cpu().data[0].numpy()
        output3 = output3.cpu().data[0].numpy()
        output4 = output4.cpu().data[0].numpy()
        # output5 = output5.cpu().data[0].numpy()
        # output6 = output6.cpu().data[0].numpy()
        # output7 = output7.cpu().data[0].numpy()
        # output8 = output8.cpu().data[0].numpy()
        ...
        # output6 = output6.transpose(1, 2, 0)
        # output7 = output7.transpose(1, 2, 0)
        # output8 = output8.transpose(1, 2, 0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="DSANet", help="model name: DSANet")
    ...
    parser.add_argument('--checkpoint', type=str,
                        default="./checkpoint/camvid/DABNetbs16gpu1_train/model_121.pth",
